...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        itemModelGenerator.register(ModItems.CAP_ITEM, Models.GENERATED);
        itemModelGenerator.register(ModItems.SNACK_CAKES_ITEM, Models.GENERATED);
        itemModelGenerator.register(ModItems.STIMPAK_ITEM, Models.GENERATED);
    }
}