...
public class PowerArmorHelmetItem extends BlockItem implements Equipment {
    ...
    public static boolean dispenseArmor(BlockPointer pointer, ItemStack armor) {
        ...
        List<Entity> list = pointer.getWorld().getEntitiesByClass(Entity.class, new Box(blockPos), EntityPredicates.EXCEPT_SPECTATOR.and(new EntityPredicates.Equipable(armor)));
        if (list.isEmpty()) {
            return false;
        }
    ...
    public PowerArmorHelmetItem(ArmorMaterial material, ArmorItem.Type type, Block block, Item.Settings settings) {
        super(block, settings.maxDamageIfAbsent(material.getDurability(type)));
